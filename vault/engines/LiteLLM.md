...
## 실전 사례
- [EP05. LiteLLM 설정](../../docs/구축기-v1.0/EP05-LiteLLM-설정.md) — 팀별 가상 키·예산 분리로 실제 설정 파일을 짠 과정
- [EP10. LiteLLM 게이트웨이 구성](../../docs/구축기-v1.0/EP10-LiteLLM-게이트웨이-구성.md) — Postgres로 가상 키를 영속화하고 실제로 발급한 과정
- [EP14. 모델 업데이트 전략](../../docs/구축기-v1.0/EP14-모델-업데이트-전략.md) — 모델 별칭(alias)만 바꿔 클라이언트를 안 건드리고 뒷단 모델을 교체한 사례
